...
public class JanusCoreEvent {
  ...
  /**
   * The root record for a Janus core event, containing information about the emitter, event type,
   * subtype, timestamp, and the nested event details.
   *
  ...
  /**
   * The record representing a core event within Janus, including the status information and
   * additional details provided by the nested Info record.
   *
  ...
  /**
   * The record representing information associated with a Janus core event, including the number of
   * sessions, handles, peer connections, and the statistics period.
   *
