...
public class JanusWebRTCStateEvent {
	 ...
	 */
	public record Root(String emitter, int type, int subtype, long timestamp, long session_id, long handle_id, String opaque_id, Event event) {
	}
	...
	public Map<DatabaseConnection, List<String >> trackInsert( Root root ) {
		...
		var sql= "INSERT INTO janus_ice (session, handle, stream, component, state, timestamp,local_candidate,remote_candidate) VALUES ("
				+ root.session_id() + ", "
				+ root.handle_id() + ", "
