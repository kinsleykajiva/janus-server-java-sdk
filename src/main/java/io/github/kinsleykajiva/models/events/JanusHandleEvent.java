...
public class JanusHandleEvent {
  ...
  /**
   * The root record for a Janus handle event, containing information about the emitter, event type,
  ...
  /**
   * The record representing a handle event within Janus, including the name, associated plugin, and
   * opaque ID details.
   */
