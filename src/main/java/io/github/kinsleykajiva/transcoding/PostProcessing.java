...
/**
 * The PostProcessing interface defines the callback methods for handling the processing lifecycle
 * of files.
 */
public interface PostProcessing {

  void onProcessingStarted(
      String roomId, long millisecondsTimeStamp, List<FileInfoMJR> fileInfoMJRs, Thread thread);
