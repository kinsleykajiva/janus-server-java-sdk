...
public class JanusStreamingPlugInAPI {
  ...
  public JSONObject createMountingPoint(
      ...
      boolean isPrivate,
      boolean permanent,
      @NotNull String mediaStringJsonArray) {
   ...
   * @param permanent Indicates whether the mounting point should be permanent or temporary.
   * @return A JSONObject containing the response from the Janus server after attempting to edit the
   ...
   * @return A JSONObject containing the response from the Janus server after attempting to delete
   *     the mounting point. The response will have the structure: &lt;p&gt; &lt;code&gt; { "janus":
   *     "success" or "error", "transaction": "&lt;transaction_id&gt;", "session_id":
   *     &lt;session_id&gt;, "handle_id": &lt;handle_id&gt;, "sender": &lt;sender_id&gt;,
   ...
   * @return A JSONObject containing the response from the Janus server after attempting to enable
   *     the mounting point. The response will have the structure: &lt;p&gt; &lt;code&gt; { "janus":
   *     "success" or "error", "transaction": "&lt;transaction_id&gt;", "session_id":
   *     &lt;session_id&gt;, "handle_id": &lt;handle_id&gt;, "sender": &lt;sender_id&gt;,
   ...
   * @return A JSONObject containing the response from the Janus server after attempting to kick all
   ...
   *     Example: '["audio", "video"]'
   * @return A JSONObject containing the response from the Janus server after attempting to start
   ...
   *     Example: '["audio", "video"]'
   * @return A JSONObject containing the response from the Janus server after attempting to stop
   *     recording. The response will have the structure: &lt;p&gt; &lt;code&gt; { "janus":
   *     "success" or "error", "transaction": "&lt;transaction_id&gt;", "session_id":
   *     &lt;session_id&gt;, "handle_id": &lt;handle_id&gt;, "sender": &lt;sender_id&gt;,
   *     "plugindata": { "plugin": "janus.plugin.streaming", "data": { "streaming": "event",
