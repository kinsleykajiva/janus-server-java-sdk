...
public class Playground {
  ...
  public static void main(String[] args) {
    ...
    JanusEventsEmissions emissionsMock =
        new JanusEventsEmissions() {
          @Override
          public void onParticipantJoined(
              long participantId, String participantDisplay, String roomId) {
            System.out.println(
                "Participant joined" + participantId + " " + participantDisplay + " " + roomId);
          }
          ...
          public void onParticipantLeft(
              long participantId, String participantDisplay, String roomId) {
            System.out.println(
                "Participant left" + participantId + " " + participantDisplay + " " + roomId);
          }

          @Override
          public void onRoomSessionStarted(
              String roomId, long firstParticipantId, String firstParticipantDisplay) {
            System.out.println(
                "Room session started" + firstParticipantId + " " + firstParticipantDisplay);
          }
        ...
        new MediaFactory(
            ...
            new PostProcessing() {
              ...
              public void onProcessingEnded(
                  String roomId, long millisecondsTimeStamp, List<File> outputs, Thread thread) {
                System.out.println(
                    "Processing ended "
                        + roomId
                        + " "
              ...
              public void onProcessingFailed(
                  String roomId, long millisecondsTimeStamp, String error) {
                System.out.println(
                    "Processing failed " + roomId + " " + millisecondsTimeStamp + " " + error);
              }

              @Override
              public void onCleanUpStarted(
                  String roomId, long millisecondsTimeStamp, Set<String> filesToCleanup) {
                System.out.println(
                    "Clean up started "
                        + roomId
                        + " "
              ...
              public void onCleanUpFailed(String roomId, long millisecondsTimeStamp, String error) {
                System.out.println(
                    "Clean up failed " + roomId + " " + millisecondsTimeStamp + " " + error);
              }
  ...
  public static void main0(String[] args) {
    ...
    DBAccess dbAccess = DBAccess.getInstance();
    DatabaseConfig mySqlConfig =
        new MySqlConfiguration("localhost", 3306, "mydatabase", "username", "password");
